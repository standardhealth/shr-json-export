...
const {IdentifiableValue, RefValue, ChoiceValue, TBD, IncompleteValue, ValueSetConstraint, CodeConstraint, CardConstraint, TypeConstraint} = require('shr-models');

// *SHR
function exportToJSON(namespaces) {
// 1{ label: SHR, type: SHR}
//		2{ label: <namespace>, type: "Namespace" }
  const result = [];
